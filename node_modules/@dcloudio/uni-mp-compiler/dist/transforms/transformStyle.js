...
function rewriteStyle(index, styleBindingProp, props, virtualHost, context, elementId) {
    ...
    if (virtualHost) {
        styleBidingExpr = styleBidingExpr
            ? (0, types_1.binaryExpression)('+', addSemicolon(styleBidingExpr), (0, types_1.logicalExpression)('||', (0, types_1.identifier)(uni_shared_1.VIRTUAL_HOST_STYLE), (0, types_1.stringLiteral)('')))
