...
export declare const SET_UNI_ELEMENT_ID: unique symbol;
export declare const SET_UNI_ELEMENT_STYLE: unique symbol;
export declare const GEN_UNI_ELEMENT_ID: unique symbol;
