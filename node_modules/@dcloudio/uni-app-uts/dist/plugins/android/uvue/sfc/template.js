...
function onTemplateLog(type, error, code, relativeFileName, templateStartLine) {
    const char = type === 'warn' ? uni_cli_shared_1.SPECIAL_CHARS.WARN_BLOCK : uni_cli_shared_1.SPECIAL_CHARS.ERROR_BLOCK;
    ...
    if (error.loc) {
        ...
        console.log('at ' +
            ...
            ':' +
            (start.column - 1));
        console.log((0, uni_cli_shared_1.generateCodeFrameColumns)(code, error.loc) + char);
    }
}
