...
exports.initRuntimeHelpersOnce = (0, uni_shared_1.once)(() => {
    (0, compiler_core_1.registerRuntimeHelpers)({
        ...
        [compiler_core_1.CREATE_VNODE]: `_cV`,
        [compiler_core_1.CREATE_ELEMENT_VNODE]: `_cE`,
        [compiler_core_1.CREATE_COMMENT]: `_cC`,
        [compiler_core_1.TO_DISPLAY_STRING]: `_tD`,
        [compiler_core_1.NORMALIZE_CLASS]: `_nC`,
        [compiler_core_1.NORMALIZE_STYLE]: `_nS`,
    });
});
