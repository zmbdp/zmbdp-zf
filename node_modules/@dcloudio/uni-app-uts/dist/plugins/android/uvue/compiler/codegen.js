...
function createCodegenContext(ast, { rootDir = '', targetLanguage = 'kotlin', mode = 'default', prefixIdentifiers = mode === 'module', bindingMetadata = {}, inline = false, sourceMap = false, filename = '', matchEasyCom = shared_1.NOOP, parseUTSComponent = shared_1.NOOP, parseUTSCustomElement = shared_1.NOOP, originalLineOffset = 0, 
...
function parseTag(tag, curNode, { parseUTSComponent, parseUTSCustomElement, targetLanguage }) {
